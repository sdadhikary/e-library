...
//	PreparedStatement gr_detail=null;
	...
	PreparedStatement gr_s_dept=null;
	...
	//	gr_detail=connection.prepareStatement("insert into gr_detail values(?,?)");
		...
		gr_s_dept=connection.prepareStatement("insert into gr_s_dept values(?,?,?,?,?,?)");
		...
		String C_SEM=request.getParameter("C_SEM");
		...
		gr_name.executeUpdate();
	 	...
	 	gr_s_dept.setString(1,GR_NO);	
		gr_s_dept.setString(2,DEPT);
		gr_s_dept.setString(3,CLAS);
		gr_s_dept.setString(4,C_YEAR);
		gr_s_dept.setString(5,C_SEM);
		gr_s_dept.setString(6,YOA);
		gr_s_dept.executeUpdate();
		...
		//out.println("YOUR PASSWORD IS : "+ PWD);%><script>alert("Your Password Is:- <%= PWD %>");</script><a href="login-reg.jsp">LOGIN</a><%
	}
	catch(ClassNotFoundException ce)
	{%>
		<a href="reg11.jsp">LOGIN</a>//out.println("Error "+ce);
	<%}
	catch(SQLException se)
	{%><a href="reg11.jsp">LOGIN</a>
